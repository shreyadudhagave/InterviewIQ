...
function SetUp1({ onStart }) {
  ...
  const handleUploadResume = async () => {
    ...
    try {
      ...
      setExperirnce(result.data.experience || "");
  ...
  return (
    ...
    >
      <div className="w-full max-w-6xl bg-white rounded-3xl shadow-2xl grid md:grid-cols-2 overflow-hidden">
        ...
        >
          <h2 className="text-3xl font-bold text-gray-800">Intreview SetUp</h2>
          <div className="space-y-6">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-green-500 outline-none transition"
                onChange={(e) => setExperirnce(e.target.value)}
                value={experience}
              />
            </div>
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {skills.map((s, i) => (
                        <span
                          key={i}
                          className="bg-green-100 text-green-70 px-3 py-1 rounded-full text-sm"
                        >
                          {s}
                        </span>
                      ))}
            ...
            <motion.button
              ...
              whileHover={{ scale: 1.03 }}
              whileTap={{ scale: 0.95 }}
              className="w-full disabled:bg-gray-600 bg-green-600 hover:bg-green-700 text-white py-3 rounded-full text-lg font-semibold transition duretion-300 shadow-md"
            >
