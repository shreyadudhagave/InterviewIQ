              ...
              {[
                {
                  ...
                  decs: "Behavioral and Communication based evaluation.",
                },
                {
                  image: techImg,
                  title: "Technical Mode",
                  decs: "Deep technical questioning based on selected role.",
                },
                {
                  image: confidenceImg,
                  title: "Confidence Detection",
                  decs: "Basic tone and voice analysis insights.",
                },
                {
                  image: creditImg,
                  title: "Credits System",
                  decs: "TUnlock premium interview sessions easily.",
                },
              ].map((mode, index) => (
                <motion.div
                  key={index}
